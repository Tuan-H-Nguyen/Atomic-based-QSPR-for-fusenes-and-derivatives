...
ax[0][0].pie(sizes[::-1],explode = explode_list[::-1],labels = labels[::-1] ,autopct="%1.f%%")

print(total)
ax[0][0].set_title("A. Distribution of the mixed dataset", 
...
ax[1][0].set_title("B. Distribution of the PAH dataset",
    bbox = dict(edgecolor = "black", facecolor = "none" ),
     **annotate)
